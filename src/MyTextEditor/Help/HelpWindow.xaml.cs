...
public partial class HelpWindow : Window
{
    ...
    [
        ...
        Topic("작업 매크로", "검색·치환·삭제·정리를 원하는 순서로 조립해 저장하고 다시 실행합니다.", ["매크로", "자동화", "단계", "JSON", "반복 작업"],
            ...
            Section("찾은 줄 추적", "검색 후 줄 내용이 바뀌어도 찾았던 줄을 계속 처리합니다. 다시 검색하면 대상이 바뀝니다. 분할된 줄은 원래 대상 여부를 이어받고, 찾은 줄 합치기는 서로 연속된 구간만 합칩니다. 대상 줄 삭제와 대상 줄만 남기기는 서로 다른 동작입니다."),
